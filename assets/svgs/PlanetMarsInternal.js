...
const SvgPlanetMarsInternal = (props) => (
  <Svg
  ...
  >
    <Defs>
      <Circle id="planet-mars-internal_svg__a" cx={168} cy={168} r={168} />
      <Circle id="planet-mars-internal_svg__c" cx={168} cy={168} r={168} />
      <Circle id="planet-mars-internal_svg__e" cx={168} cy={168} r={168} />
      <Circle id="planet-mars-internal_svg__g" cx={168} cy={168} r={168} />
      <Path
        id="planet-mars-internal_svg__i"
        d="M0 0c88.918 0 161 72.082 161 161S88.918 322 0 322z"
      />
    </Defs>
    <G fill="none" fillRule="evenodd">
      <Circle cx={168} cy={168} r={168} fill="#FF6A45" fillRule="nonzero" />
      <Mask id="planet-mars-internal_svg__b" fill="#fff">
        <Use xlinkHref="#planet-mars-internal_svg__a" />
      </Mask>
      <Path
        fill="#FF9B6B"
        fillRule="nonzero"
        ...
        mask="url(#planet-mars-internal_svg__b)"
      />
      <Mask id="planet-mars-internal_svg__d" fill="#fff">
        <Use xlinkHref="#planet-mars-internal_svg__c" />
      </Mask>
      <Path
        fill="#FF9B6B"
        fillRule="nonzero"
        ...
        mask="url(#planet-mars-internal_svg__d)"
      />
      <Mask id="planet-mars-internal_svg__f" fill="#fff">
        <Use xlinkHref="#planet-mars-internal_svg__e" />
      </Mask>
      <Path
        fill="#D04237"
        fillRule="nonzero"
        ...
        mask="url(#planet-mars-internal_svg__f)"
      />
      <Mask id="planet-mars-internal_svg__h" fill="#fff">
        <Use xlinkHref="#planet-mars-internal_svg__g" />
      </Mask>
      <Path
        fill="#000"
        fillRule="nonzero"
        d="M169-16h184v368H169z"
        mask="url(#planet-mars-internal_svg__h)"
        opacity={0.078}
      />
      <G transform="translate(169 7)">
        <Mask id="planet-mars-internal_svg__j" fill="#fff">
          <Use xlinkHref="#planet-mars-internal_svg__i" />
        </Mask>
        <Use xlinkHref="#planet-mars-internal_svg__i" fill="#97271E" />
        <Circle
          cx={1}
          cy={161}
          r={154}
          fill="#DC5D1C"
          mask="url(#planet-mars-internal_svg__j)"
        />
        <Circle
          cx={1}
          cy={161}
...
export default SvgPlanetMarsInternal;
