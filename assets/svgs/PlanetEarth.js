...
const SvgPlanetEarth = (props) => (
  ...
  >
    <Defs>
      <Circle id="planet-earth_svg__a" cx={225} cy={225} r={225} />
      <Circle id="planet-earth_svg__c" cx={225} cy={225} r={225} />
      <Circle id="planet-earth_svg__e" cx={225} cy={225} r={225} />
      <Circle id="planet-earth_svg__g" cx={225} cy={225} r={225} />
      <Circle id="planet-earth_svg__i" cx={225} cy={225} r={225} />
      <Circle id="planet-earth_svg__k" cx={225} cy={225} r={225} />
    </Defs>
    <G fill="none" fillRule="evenodd">
      <Circle cx={225} cy={225} r={225} fill="#545BFE" fillRule="nonzero" />
      <Mask id="planet-earth_svg__b" fill="#fff">
        <Use xlinkHref="#planet-earth_svg__a" />
      </Mask>
      <Path
        fill="#4FCDF9"
        fillRule="nonzero"
        ...
        mask="url(#planet-earth_svg__b)"
      />
      <Mask id="planet-earth_svg__d" fill="#fff">
        <Use xlinkHref="#planet-earth_svg__c" />
      </Mask>
      <Path
        fill="#4FCDF9"
        fillRule="nonzero"
        ...
        mask="url(#planet-earth_svg__d)"
      />
      <Mask id="planet-earth_svg__f" fill="#fff">
        <Use xlinkHref="#planet-earth_svg__e" />
      </Mask>
      <Path
        fill="#FFF"
        fillRule="nonzero"
        ...
        mask="url(#planet-earth_svg__f)"
      />
      <Mask id="planet-earth_svg__h" fill="#fff">
        <Use xlinkHref="#planet-earth_svg__g" />
      </Mask>
      <Path
        fill="#FFF"
        fillRule="nonzero"
        ...
        mask="url(#planet-earth_svg__h)"
      />
      <Mask id="planet-earth_svg__j" fill="#fff">
        <Use xlinkHref="#planet-earth_svg__i" />
      </Mask>
      <Path
        fill="#FFF"
        fillRule="nonzero"
        d="M349 459c0-6.627-5.373-12-12-12h-68c-6.627 0-12-5.373-12-12s5.373-12 12-12h101c6.627 0 12-5.373 12-12s-5.373-12-12-12h-23c-6.627 0-12-5.373-12-12s5.373-12 12-12h118c6.627 0 12 5.373 12 12s-5.373 12-12 12h-47v.01c-6.395.262-11.5 5.53-11.5 11.99s5.105 11.728 11.5 11.99v.01h14c6.627 0 12 5.373 12 12s-5.373 12-12 12h-26l-.001.01c-6.395.263-11.499 5.53-11.499 11.99s5.104 11.727 11.499 11.99l.001.01h3c6.627 0 12 5.373 12 12s-5.373 12-12 12h-76c-6.627 0-12-5.373-12-12s5.373-12 12-12h4c6.627 0 12-5.373 12-12m151-36c6.627 0 12 5.373 12 12s-5.373 12-12 12h-20c-6.627 0-12-5.373-12-12s5.373-12 12-12z"
        mask="url(#planet-earth_svg__j)"
      />
      <Mask id="planet-earth_svg__l" fill="#fff">
        <Use xlinkHref="#planet-earth_svg__k" />
      </Mask>
      <Path
        fill="#000"
        fillRule="nonzero"
        d="M225.484-25h250.484v500H225.484z"
        mask="url(#planet-earth_svg__l)"
        opacity={0.078}
      />
    </G>
  </Svg>
);
export default SvgPlanetEarth;
