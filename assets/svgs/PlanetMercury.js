...
const SvgPlanetMercury = (props) => (
  ...
  >
    <Defs>
      <Circle id="planet-mercury_svg__a" cx={145} cy={145} r={145} />
      <Circle id="planet-mercury_svg__c" cx={145} cy={145} r={145} />
    </Defs>
    <G fill="none" fillRule="evenodd">
      <Circle cx={145} cy={145} r={145} fill="#DEF4FC" fillRule="nonzero" />
      <Mask id="planet-mercury_svg__b" fill="#fff">
        <Use xlinkHref="#planet-mercury_svg__a" />
      </Mask>
      <Path
        fill="#B1D5E2"
        fillRule="nonzero"
        ...
        mask="url(#planet-mercury_svg__b)"
      />
      <Mask id="planet-mercury_svg__d" fill="#fff">
        <Use xlinkHref="#planet-mercury_svg__c" />
      </Mask>
      <Path
        fill="#000"
        fillRule="nonzero"
        d="M146 0h145v290H146z"
        mask="url(#planet-mercury_svg__d)"
        opacity={0.078}
      />
    </G>
  </Svg>
);
export default SvgPlanetMercury;
