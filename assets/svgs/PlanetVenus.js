...
const SvgPlanetVenus = (props) => (
  ...
  >
    <Defs>
      <Circle id="planet-venus_svg__a" cx={200} cy={200} r={200} />
      <Circle id="planet-venus_svg__c" cx={200} cy={200} r={200} />
      <Circle id="planet-venus_svg__e" cx={200} cy={200} r={200} />
    </Defs>
    <G fill="none" fillRule="evenodd">
      <Circle cx={200} cy={200} r={200} fill="#F7CC7F" fillRule="nonzero" />
      <Mask id="planet-venus_svg__b" fill="#fff">
        <Use xlinkHref="#planet-venus_svg__a" />
      </Mask>
      <Path
        fill="#FFE6AE"
        fillRule="nonzero"
        ...
        mask="url(#planet-venus_svg__b)"
      />
      <Mask id="planet-venus_svg__d" fill="#fff">
        <Use xlinkHref="#planet-venus_svg__c" />
      </Mask>
      <Path
        fill="#E29F58"
        fillRule="nonzero"
        ...
        mask="url(#planet-venus_svg__d)"
      />
      <Mask id="planet-venus_svg__f" fill="#fff">
        <Use xlinkHref="#planet-venus_svg__e" />
      </Mask>
      <Path
        fill="#000"
        fillRule="nonzero"
        d="M201-25h225v450H201z"
        mask="url(#planet-venus_svg__f)"
        opacity={0.078}
      />
    </G>
  </Svg>
);
export default SvgPlanetVenus;
